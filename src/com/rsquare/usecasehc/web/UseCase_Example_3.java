...
public class UseCase_Example_3 {
	...
	public static void main(String[] args) {
		 String directory = "B:\\rsquare\\usecase_hc\\rdfout_dev" ;
		 Dataset dataset = TDBFactory.createDataset(directory);
		 Model model = dataset.getDefaultModel();
		 
//		 String sql = FileManager.get().readWholeFileAsUTF8("file:///B:\\rsquare\\usecase_hc\\query_1.txt");
		 String sql = FileManager.get().readWholeFileAsUTF8("./queries/query_3.txt");
...
//	      String referral_count = FmtUtils.stringForRDFNode(z);
	      ...
	      {
	    	  System.out.println("==== Already present ======" + referred_doctor );
	    	  continue;
	      }
